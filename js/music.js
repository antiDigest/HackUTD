...
var start_convnet = function() {
  // load test batches of music
  load_from_json();
  load_data_batch();
}

// Load test data batch of 5 songs
var img_data = null;
var load_data_batch = function() {
  ...
  data_img_elt.onload = function() { 
    ...
    var data_ctx = data_canvas.getContext("1d");
  ...
  data_img_elt.src = "music/01 - Ajab Si-(MyMp3Singer.net).mp3";
}
